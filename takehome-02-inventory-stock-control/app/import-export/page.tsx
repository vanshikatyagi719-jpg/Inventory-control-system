    ...
    >
      <div style={{ maxWidth: '1240px', margin: '0 auto' }}>
        ...
        <nav style={{ display: 'flex', gap: '8px', marginBottom: '32px', flexWrap: 'wrap' }}>
          ...
          <Link href="/import-export" style={{ ...navStyle, backgroundColor: '#0f172a', color: 'white', borderColor: '#0f172a' }}>Bulk CSV</Link>
        </nav>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(500px, 1fr))', gap: '24px' }}>
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
              <h2 style={{ margin: 0, fontSize: '16px', fontWeight: 700, color: '#0f172a' }}>1. Bulk Item Catalog Import</h2>
              <button
                type="button"
            ...
            {itemsResult && (
              <div style={{ marginTop: '20px', padding: '16px', backgroundColor: itemsResult.failedCount === 0 ? '#f0fdf4' : '#fffbeb', borderRadius: '6px', border: '1px solid #e2e8f0' }}>
                <div style={{ fontWeight: 600, fontSize: '14px', color: itemsResult.failedCount === 0 ? '#166534' : '#92400e' }}>
                ...
                {itemsResult.errors.length > 0 && (
                  <div style={{ marginTop: '12px' }}>
                    <div style={{ fontSize: '12px', fontWeight: 700, color: '#991b1b', marginBottom: '6px' }}>Row Validation Errors:</div>
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
              <h2 style={{ margin: 0, fontSize: '16px', fontWeight: 700, color: '#0f172a' }}>2. Bulk Stock Receipts Import</h2>
              <button
                type="button"
            ...
            {receiptsResult && (
              <div style={{ marginTop: '20px', padding: '16px', backgroundColor: receiptsResult.failedCount === 0 ? '#f0fdf4' : '#fffbeb', borderRadius: '6px', border: '1px solid #e2e8f0' }}>
                <div style={{ fontWeight: 600, fontSize: '14px', color: receiptsResult.failedCount === 0 ? '#166534' : '#92400e' }}>
